...
export default async function ManageAppsPage() {
  ...
  const formattedApps: AppItemData[] = visibleApps.map((a) => {
    ...
    return {
      ...
      ownerId: a.app_id || a.owner_id || a.owner_secret || "0FY7WpdIue",
      secret: a.app_secret || a.owner_secret || "7f40bd3c9ffd860495dff6676f8ecd45c08e8b183a23d09db78a3fde27cddd4f",
