      ...
      <div className="w-full max-w-7xl mx-auto px-4 z-10 flex flex-col justify-between min-h-[90vh] py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-auto">
          ...
          <div className="lg:col-span-6 space-y-8 flex flex-col justify-center text-center lg:text-left">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-center lg:justify-start gap-4">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 flex items-center justify-center shadow-lg shadow-emerald-500/10 relative overflow-hidden group">
                  <div className="absolute inset-0 bg-gradient-to-t from-emerald-500/20 to-transparent opacity-100" />
                  <img src="/logo.png" alt="Spectral X Logo" className="w-10 h-10 object-contain relative z-10 filter drop-shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                </div>
                <div>
                  <h1 className="text-4xl lg:text-5xl font-black tracking-wider bg-gradient-to-r from-white via-zinc-200 to-emerald-400 bg-clip-text text-transparent uppercase">
                    Spectral X
                  </h1>
                  <p className="text-[10px] tracking-[0.25em] font-bold text-emerald-400/90 uppercase mt-0.5">
              ...
              <div className="flex justify-center lg:justify-start">
                <svg className="w-6 h-6 text-emerald-400/40 fill-current animate-pulse" viewBox="0 0 24 24">
            ...
            {/* Info Card */}
            <div className="bg-emerald-950/10 border border-emerald-500/15 p-6 rounded-2xl max-w-xl mx-auto lg:mx-0 backdrop-blur-md">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-xl mx-auto lg:mx-0 text-left">
              <div className="bg-zinc-950/40 border border-zinc-800/60 p-4 rounded-xl flex items-start gap-3 backdrop-blur-sm">
                <div className="w-8 h-8 rounded-lg bg-emerald-950/50 border border-emerald-500/20 flex items-center justify-center shrink-0">
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="w-full max-w-[460px] relative">
              {/* Outer Neon Glow */}
              <div className="absolute -inset-1.5 bg-emerald-500/20 rounded-3xl blur-xl opacity-75 pointer-events-none animate-pulse" />
              
              <div className="relative rounded-3xl border border-emerald-500/30 bg-zinc-950/90 backdrop-blur-2xl p-8 md:p-10 shadow-[0_25px_60px_rgba(0,0,0,0.8)]">
                
                {/* Hexagonal Lock Badge at Top */}
                <div className="w-16 h-16 mx-auto mb-6 relative flex items-center justify-center">
                  <div className="absolute inset-0 bg-emerald-500/10 rounded-2xl rotate-45 border border-emerald-500/40 shadow-lg shadow-emerald-950/50" />
                  <Lock className="w-6 h-6 text-emerald-400 relative z-10 animate-pulse" />
                </div>
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-[11px] text-zinc-500 mt-1">
                    Accede a tu cuenta de <span className="text-emerald-400 font-medium">Spectral X</span>
                  </p>
                </div>
        ...
        <div className="mt-8 pt-6 border-t border-zinc-800/40 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-zinc-500 font-mono tracking-wider w-full uppercase">
          ...
          <div className="text-center">
            SPECTRAL X KEYAUTH SYSTEM &copy; {new Date().getFullYear()} Spectral X. Todos los derechos reservados.
          </div>
          <div className="flex items-center gap-2">
