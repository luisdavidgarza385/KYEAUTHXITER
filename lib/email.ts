// HTML Email Template Generator matching Image 3 layouts
...
<style>
  ...
  .btn-green { display: inline-block; background: #00b060; color: #ffffff; text-decoration: none; font-size: 13px; font-weight: 700; padding: 12px 24px; border-radius: 12px; margin: 16px 0 24px 0; width: 100%; text-align: center; box-sizing: border-box; }
  ...
  .footer-links { display: flex; justify-content: space-around; text-align: center; font-size: 11px; font-weight: 700; color: #475569; border-top: 1px solid #f1f5f9; pt: 16px; margin-top: 20px; }
  ...
  <div class="card">
    ...
    <div class="box">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:14px;">
        <div style="width:36px;height:36px;border-radius:10px;background:#6366f1;color:#fff;display:flex;align-items:center;justify-content:center;font-weight:bold;">S</div>
        <div>
    ...
    <div class="status-box">
      ...
      <div>
        ...
        <span style="font-weight:normal;">Tu Keyau ha sido activada correctamente.</span>
      </div>
    </div>
...
<style>
  ...
  .auth-box { background: #f3e8ff; border: 1px solid #e9d5ff; color: #6b21a8; border-radius: 16px; padding: 16px; font-size: 12px; margin-bottom: 20px; }
  .prot-box { background: #faf5ff; border: 1px solid #f3e8ff; border-radius: 16px; padding: 16px; margin-bottom: 20px; }
  .footer-links { display: flex; justify-content: space-around; text-align: center; font-size: 11px; font-weight: 700; color: #475569; border-top: 1px solid #f1f5f9; pt: 16px; }
  .footer-links a { color: #475569; text-decoration: none; }
</style>
</head>
<body>
  <div class="card">
    ...
    <div class="auth-box">
      <div style="display:flex;align-items:center;gap:10px;">
        <div style="width:28px;height:28px;border-radius:50%;background:#7e22ce;color:#fff;display:flex;align-items:center;justify-content:center;font-weight:bold;">✓</div>
        <div>
          <strong style="color:#581c87;">Keyau autenticada</strong><br/>
          <span style="font-size:11px;color:#7e22ce;">La licencia SecureX Auth está activa y funcionando correctamente.</span>
        </div>
      </div>
    </div>
    ...
    <div class="prot-box">
      <div style="font-size:12px;font-weight:700;color:#581c87;margin-bottom:4px;">🛡️ Tu Keyau está protegida</div>
      <div style="font-size:11px;color:#7e22ce;line-height:1.4;">No compartas tu clave de licencia con nadie. SecureX Auth protege tu acceso.</div>
    </div>
