...
async function bootstrap() {
  ...
  // Master Admin
  if (!db.admins.find((a) => a.email.toLowerCase() === "spectralx@gmail.com" || a.email.toLowerCase() === "spectralx")) {
    db.admins.push({
      id: id(),
      email: "spectralx@gmail.com",
      password_hash: await bcrypt.hash("SpectralX", 10),
      role: "admin",
      created_at: now(),
      subscription_end: null, // Unlimited
      subscription_app_id: null,
      seller_label: "SpectralX",
      credits: 999999999,
      status: "Activo",
